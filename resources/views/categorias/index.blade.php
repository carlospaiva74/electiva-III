                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="row">
                                ...
                                <div class="col">
                                    <a href="{{route('categorias.create')}}" class="btn btn-primary mb-2 float-right">Registrar</a>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="javascript:eliminar('{{route('categorias.destroy',$key->id)}}','{{$key->nombre}}')"
                                                    class="bs-tooltip" 
